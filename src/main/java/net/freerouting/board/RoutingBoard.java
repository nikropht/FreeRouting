...
public class RoutingBoard extends BasicBoard implements java.io.Serializable
{
     ...
     */
    public AutorouteEngine.AutorouteResult autoroute(Item p_item, net.freerouting.interactive.Settings p_settings, int p_via_costs, Stoppable p_stoppable_thread, TimeLimit p_time_limit)
    {
        ...
        net.freerouting.rules.Net route_net = rules.nets.get(route_net_no);
     ...
     *  Returns an enum of type AutorouteEngine.AutorouteResult
     */
    public AutorouteEngine.AutorouteResult fanout(Pin p_pin, net.freerouting.interactive.Settings p_settings, int p_ripup_costs,
