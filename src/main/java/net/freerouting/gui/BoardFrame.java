...
public class BoardFrame extends javax.swing.JFrame {
    ...
    private final net.freerouting.datastructures.IdNoGenerator item_id_no_generator;
    ...
    public BoardFrame(DesignFile p_design, Option p_option, TestLevel p_test_level,
        ...
        this(p_design, p_option, p_test_level,
                new net.freerouting.board.BoardObserverAdaptor(), new net.freerouting.board.ItemIdNoGenerator(),
    ...
    BoardFrame(DesignFile p_design, Option p_option, TestLevel p_test_level, BoardObservers p_observers,
        ...
        this.resources = java.util.ResourceBundle.getBundle("net.freerouting.gui.BoardFrame", p_locale);
    ...
    boolean read(InputStream p_input_stream, boolean p_is_import, javax.swing.JTextField p_message_field) {
        ...
        if (p_is_import) {
            ...
            if (defaults_file_found) {
                boolean read_ok = net.freerouting.gui.GUIDefaultsFile.read(this, board_panel.board_handling, input_stream);
                if (!read_ok) {
