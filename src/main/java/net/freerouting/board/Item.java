...
import net.freerouting.boardgraphics.Drawable;
...
public abstract class Item implements Drawable, SearchTreeObject, ObjectInfoPanel.Printable, UndoableObjects.Storable, Serializable {
     ...
     */
    transient private net.freerouting.autoroute.ItemAutorouteInfo autoroute_info = null;
     ...
     */
    public net.freerouting.autoroute.ItemAutorouteInfo get_autoroute_info() {
        if (autoroute_info == null) {
            autoroute_info = new net.freerouting.autoroute.ItemAutorouteInfo(this);
        }
     ...
     * Gets the information for the autoroute algorithm.
     */
    public net.freerouting.autoroute.ItemAutorouteInfo get_autoroute_info_pur() {
        return autoroute_info;
    }
    ...
    protected void print_net_info(ObjectInfoPanel p_window, java.util.Locale p_locale) {
        ...
        for (int i = 0; i < this.net_count(); ++i) {
            ...
            net.freerouting.rules.Net curr_net = board.rules.nets.get(this.get_net_no(i));
    ...
    protected void print_fixed_info(ObjectInfoPanel p_window, java.util.Locale p_locale) {
        if (this.fixed_state != FixedState.UNFIXED) {
            java.util.ResourceBundle resources =
                    java.util.ResourceBundle.getBundle("net.freerouting.board.FixedState", p_locale);
            p_window.append(", ");
