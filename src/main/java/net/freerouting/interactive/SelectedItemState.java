...
import net.freerouting.autoroute.AutorouteEngine;
...
import net.freerouting.board.Pin;
import net.freerouting.board.Item;
import net.freerouting.board.ObstacleArea;
...
import net.freerouting.board.OptViaAlgo;
...
public class SelectedItemState extends InteractiveState
{
    ...
    public InteractiveState autoroute(Stoppable p_stoppable_thread)
    {
        ...
        for (Item curr_item : autoroute_item_list)
        {
            ...
            net.freerouting.rules.Net route_net = hdlg.get_routing_board().rules.nets.get(curr_item.get_net_no(0));
            if (route_net != null)
            {
    ...
    {
        net.freerouting.board.BasicBoard routing_board = this.hdlg.get_routing_board();
    ...
    {
        net.freerouting.gui.WindowObjectInfo.display(this.item_list, hdlg.get_panel().board_frame, hdlg.coordinate_transform, new java.awt.Point(100, 100));
        return this;
    }
