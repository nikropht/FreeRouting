...
public class SnapShot implements java.io.Serializable
{
    ...
    private SnapShot(String p_name, BoardHandling p_board_handling)
    {
        ...
        this.graphics_context = new net.freerouting.boardgraphics.GraphicsContext(p_board_handling.graphics_context);
     ...
     */
    public void go_to(net.freerouting.interactive.BoardHandling p_board_handling)
    {
        net.freerouting.interactive.SnapShot.Attributes snapshot_attributes = this.settings.snapshot_attributes;

        if (snapshot_attributes.object_visibility)
        {
            p_board_handling.graphics_context.color_intensity_table =
                    new net.freerouting.boardgraphics.ColorIntensityTable(this.graphics_context.color_intensity_table);
        }
        ...
        {
            p_board_handling.settings.item_selection_filter = new net.freerouting.board.ItemSelectionFilter(this.settings.item_selection_filter);
        }
    ...
    public final net.freerouting.boardgraphics.GraphicsContext graphics_context;
    private final java.awt.Point viewport_position;
    public final net.freerouting.gui.BoardFrame.SubwindowSelections subwindow_filters;
