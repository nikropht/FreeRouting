...
import net.freerouting.boardgraphics.ColorIntensityTable.ObjectNames;
...
public class WindowObjectVisibility extends WindowVisibility {
    ...
    public static WindowObjectVisibility get_instance(BoardFrame p_board_frame) {
        java.util.ResourceBundle resources =
                java.util.ResourceBundle.getBundle("net.freerouting.gui.WindowObjectVisibility", p_board_frame.get_locale());
     ...
     */
    public void refresh() {
        net.freerouting.boardgraphics.ColorIntensityTable color_intensity_table = this.get_board_handling().graphics_context.color_intensity_table;
