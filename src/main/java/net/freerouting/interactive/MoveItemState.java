...
import net.freerouting.library.BoardLibrary;
...
public class MoveItemState extends InteractiveState
{
    ...
    {
        java.util.ResourceBundle resources = java.util.ResourceBundle.getBundle("net.freerouting.interactive.InteractiveState", p_board_handling.get_locale());
        ...
        net.freerouting.board.BasicBoard routing_board = p_board_handling.get_routing_board();
            ...
            Component p_first_component, InteractiveState p_parent_state, BoardHandling p_board_handling, Logfile p_logfile)
    {
        ...
        net.freerouting.board.BasicBoard routing_board = hdlg.get_routing_board();
    ...
    private void move(FloatPoint p_new_position)
    {
        ...
        if (!current_position.equals(previous_position))
        {
            ...
            net.freerouting.board.Components components = hdlg.get_routing_board().components;
            for (Component curr_component : this.component_list)
            {
