...
public class WindowRouteStubs extends WindowObjectListWithFilter {
    ...
    protected void fill_list() {
        ...
        for (Item curr_item : board_items) {
            ...
            if (curr_item instanceof net.freerouting.board.Via) {
                ...
                stub_location = ((net.freerouting.board.Via) curr_item).get_center().to_float();
            } else {
                net.freerouting.board.Trace curr_trace = (net.freerouting.board.Trace) curr_item;
    ...
    private class RouteStubInfo implements Comparable<RouteStubInfo> {
        ...
        public String toString() {
            String item_string;
            if (this.stub_item instanceof net.freerouting.board.Trace) {
