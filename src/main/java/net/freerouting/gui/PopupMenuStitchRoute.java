...
public class PopupMenuStitchRoute extends PopupMenuDisplay {
    ...
    public PopupMenuStitchRoute(BoardFrame p_board_frame) {
        super(p_board_frame);
        net.freerouting.board.LayerStructure layer_structure = board_panel.board_handling.get_routing_board().layer_structure;
        ...
        net.freerouting.board.Layer curr_layer = layer_structure.arr[board_panel.board_handling.settings.get_layer()];
