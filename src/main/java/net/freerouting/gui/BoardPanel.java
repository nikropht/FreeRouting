...
public class BoardPanel extends javax.swing.JPanel {
    ...
    public void center_display(Point2D p_new_center) {
        ...
        repaint();
        this.board_handling.logfile.start_scope(net.freerouting.interactive.LogfileScope.CENTER_DISPLAY);
        net.freerouting.geometry.planar.FloatPoint curr_corner = new net.freerouting.geometry.planar.FloatPoint(p_new_center.getX(), p_new_center.getY());
