...
public class ItemColorTableModel extends ColorTableModel implements java.io.Serializable
{
    ...
    public ItemColorTableModel(net.freerouting.board.LayerStructure p_layer_structure, java.util.Locale p_locale)
    {
    ...
    public String getColumnName(int p_col)
    {
        java.util.ResourceBundle resources = 
                java.util.ResourceBundle.getBundle("net.freerouting.boardgraphics.ColorTableModel", this.locale);
