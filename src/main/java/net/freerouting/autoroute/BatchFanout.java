...
public class BatchFanout {
    ...
    private BatchFanout(InteractiveActionThread p_thread) {
        ...
        Collection<net.freerouting.board.Pin> board_smd_pin_list = routing_board.get_smd_pins();
    ...
    private static class Component implements Comparable<Component> {
        ...
        Component(net.freerouting.board.Component p_board_component, Collection<net.freerouting.board.Pin> p_board_smd_pin_list) {
            this.board_component = p_board_component;

            // calcoulate the center of gravity of all SMD pins of this component.
            Collection<net.freerouting.board.Pin> curr_pin_list = new java.util.LinkedList<net.freerouting.board.Pin>();
