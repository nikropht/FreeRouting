...
public class CoordinateTransform implements java.io.Serializable
{
     ...
     */
    public Shape board_to_dsn(net.freerouting.geometry.planar.Shape p_board_shape, Layer p_layer)
    {
        Shape result;
        ...
        {
            net.freerouting.geometry.planar.Circle board_circle = (net.freerouting.geometry.planar.Circle) p_board_shape;
     ...
     */
    public Shape board_to_dsn_rel(net.freerouting.geometry.planar.Shape p_board_shape, Layer p_layer)
    {
        Shape result;
        if (p_board_shape instanceof IntBox)
        {
