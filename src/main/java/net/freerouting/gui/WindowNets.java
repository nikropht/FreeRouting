...
import net.freerouting.rules.Nets;
...
public class WindowNets extends WindowObjectListWithFilter {
    ...
    public WindowNets(BoardFrame p_board_frame) {
        super(p_board_frame);
        this.resources = java.util.ResourceBundle.getBundle("net.freerouting.gui.WindowNets", p_board_frame.get_locale());
    ...
    private class AssignClassListener implements java.awt.event.ActionListener {
        public void actionPerformed(java.awt.event.ActionEvent p_evt) {
            ...
            net.freerouting.rules.NetClasses net_classes = board_frame.board_panel.board_handling.get_routing_board().rules.net_classes;
            net.freerouting.rules.NetClass[] class_arr = new net.freerouting.rules.NetClass[net_classes.count()];
            ...
            if (!(selected_value instanceof net.freerouting.rules.NetClass)) {
                return;
            }
            net.freerouting.rules.NetClass selected_class = (net.freerouting.rules.NetClass) selected_value;
            for (int i = 0; i < selected_nets.length; ++i) {
