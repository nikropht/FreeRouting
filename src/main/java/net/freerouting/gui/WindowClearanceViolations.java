...
import net.freerouting.board.ClearanceViolation;
import net.freerouting.geometry.planar.FloatPoint;
import net.freerouting.interactive.ClearanceViolations;
...
public class WindowClearanceViolations extends WindowObjectListWithFilter {
    ...
    public WindowClearanceViolations(BoardFrame p_board_frame) {
        super(p_board_frame);
        this.resources = java.util.ResourceBundle.getBundle("net.freerouting.gui.WindowClearanceViolations", p_board_frame.get_locale());
    ...
    protected void fill_list() {
        net.freerouting.interactive.BoardHandling board_handling = this.board_frame.board_panel.board_handling;
    ...
    private String item_info(net.freerouting.board.Item p_item) {
        String result;
        if (p_item instanceof net.freerouting.board.Pin) {
            result = resources.getString("pin");
        } else if (p_item instanceof net.freerouting.board.Via) {
            result = resources.getString("via");
        } else if (p_item instanceof net.freerouting.board.Trace) {
        ...
        } else if (p_item instanceof net.freerouting.board.ObstacleArea) {
            result = resources.getString("keepout");
        } else if (p_item instanceof net.freerouting.board.ViaObstacleArea) {
        ...
        } else if (p_item instanceof net.freerouting.board.BoardOutline) {
