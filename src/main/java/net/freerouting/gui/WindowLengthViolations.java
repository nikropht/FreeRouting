...
import net.freerouting.interactive.RatsNest;
...
public class WindowLengthViolations extends WindowObjectListWithFilter {
    ...
    public WindowLengthViolations(BoardFrame p_board_frame) {
        super(p_board_frame);
        this.resources = java.util.ResourceBundle.getBundle("net.freerouting.gui.WindowLengthViolations", p_board_frame.get_locale());
