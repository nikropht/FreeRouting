...
public class Plane extends ScopeKeyword {
    ...
    public static void write_scope(WriteScopeParameter p_par, net.freerouting.board.ConductionArea p_conduction) throws java.io.IOException {
        ...
        net.freerouting.geometry.planar.Area curr_area = p_conduction.get_area();
