...
public class WindowAutorouteDetailParameter extends BoardSavableSubWindow {
    ...
    public WindowAutorouteDetailParameter(BoardFrame p_board_frame) {
        ...
        java.util.ResourceBundle resources =
                java.util.ResourceBundle.getBundle("net.freerouting.gui.WindowAutorouteParameter", p_board_frame.get_locale());
        ...
        net.freerouting.board.LayerStructure layer_structure = this.board_handling.get_routing_board().layer_structure;
        ...
        for (int i = 0; i < signal_layer_count; ++i) {
            ...
            net.freerouting.board.Layer curr_signal_layer = layer_structure.get_signal_layer(i);
     ...
     */
    public void refresh() {
        net.freerouting.interactive.AutorouteSettings settings = this.board_handling.settings.autoroute_settings;
        net.freerouting.board.LayerStructure layer_structure = this.board_handling.get_routing_board().layer_structure;
