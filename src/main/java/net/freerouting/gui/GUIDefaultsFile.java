...
public class GUIDefaultsFile
{
     ...
     */
    public static boolean write(net.freerouting.gui.BoardFrame p_board_frame,
            net.freerouting.interactive.BoardHandling p_board_handling, java.io.OutputStream p_output_stream)
    {
     ...
     */
    public static boolean read(net.freerouting.gui.BoardFrame p_board_frame,
            net.freerouting.interactive.BoardHandling p_board_handling, java.io.InputStream p_input_stream)
    {
    ...
    private GUIDefaultsFile(net.freerouting.gui.BoardFrame p_board_frame, net.freerouting.interactive.BoardHandling p_board_handling,
    ...
    {
        net.freerouting.boardgraphics.GraphicsContext graphics_context = this.board_handling.graphics_context;
        out_file.start_scope();
    ...
    {
        net.freerouting.interactive.SnapShot.Attributes attributes = this.board_handling.settings.get_snapshot_attributes();
        out_file.start_scope();
    ...
    private final net.freerouting.gui.BoardFrame board_frame;
