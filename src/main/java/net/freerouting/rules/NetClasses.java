...
public class NetClasses implements java.io.Serializable {
     ...
     */
    NetClass append(String p_name, net.freerouting.board.LayerStructure p_layer_structure, ClearanceMatrix p_clearance_matrix) {
     ...
     */
    NetClass append(net.freerouting.board.LayerStructure p_layer_structure, ClearanceMatrix p_clearance_matrix, java.util.Locale p_locale) {
