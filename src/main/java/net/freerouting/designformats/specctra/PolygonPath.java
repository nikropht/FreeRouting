...
public class PolygonPath extends Path {
    ...
    public net.freerouting.geometry.planar.Shape transform_to_board(CoordinateTransform p_coordinate_transform) {
        ...
        net.freerouting.geometry.planar.Shape result = new net.freerouting.geometry.planar.PolygonShape(rounded_corner_arr);
        if (offset > 0) {
    ...
    public net.freerouting.geometry.planar.Shape transform_to_board_rel(CoordinateTransform p_coordinate_transform) {
        FloatPoint[] corner_arr = new FloatPoint[this.coordinate_arr.length / 2];
        double[] curr_point = new double[2];
        for (int i = 0; i < corner_arr.length; ++i) {
            curr_point[0] = this.coordinate_arr[2 * i];
