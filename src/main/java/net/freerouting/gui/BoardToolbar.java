...
class BoardToolbar extends javax.swing.JPanel
{
    ...
    BoardToolbar(BoardFrame p_board_frame)
    {
        ...
        java.util.ResourceBundle resources = 
                java.util.ResourceBundle.getBundle("net.freerouting.gui.BoardToolbar", p_board_frame.get_locale());
        ...
        unit_combo_box.setModel(new javax.swing.DefaultComboBoxModel(net.freerouting.board.Unit.values()));
        ...
        unit_combo_box.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                net.freerouting.board.Unit new_unit = (net.freerouting.board.Unit) unit_combo_box.getSelectedItem();
    ...
    {
        net.freerouting.interactive.InteractiveState interactive_state = this.board_frame.board_panel.board_handling.get_interactive_state();
        if (interactive_state instanceof net.freerouting.interactive.RouteMenuState)
        {
            this.route_button.setSelected(true);
        }
        else if (interactive_state instanceof net.freerouting.interactive.DragMenuState)
        {
            this.drag_button.setSelected(true);
        }
        else if (interactive_state instanceof net.freerouting.interactive.SelectMenuState)
        {
