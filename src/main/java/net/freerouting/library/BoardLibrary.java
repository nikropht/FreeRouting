...
package net.freerouting.library;
...
public class BoardLibrary implements java.io.Serializable {
     ...
     */
    public boolean remove_via_padstack(Padstack p_padstack, net.freerouting.board.BasicBoard p_board) {
     ...
     */
    public boolean is_used(Padstack p_padstack, net.freerouting.board.BasicBoard p_board) {
        ...
        for (; ; ) {
            net.freerouting.datastructures.UndoableObjects.Storable curr_item = p_board.item_list.read_object(it);
            if (curr_item == null) {
                break;
            }
            if (curr_item instanceof net.freerouting.board.DrillItem) {
                if (((net.freerouting.board.DrillItem) curr_item).get_padstack() == p_padstack) {
                    return true;
                }
            }
        }
