...
import net.freerouting.geometry.planar.Shape;
...
import net.freerouting.library.Package;
...
public class Pin extends DrillItem implements java.io.Serializable
{
    ...
    public java.util.Set<Pin> get_swappable_pins()
    {
        ...
        net.freerouting.library.LogicalPart logical_part = component.get_logical_part();
        if (logical_part == null)
        {
            return result;
        }
        net.freerouting.library.LogicalPart.PartPin this_part_pin = logical_part.get_pin(this.pin_no);
        ...
        for( int i = 0; i < logical_part.pin_count(); ++i)
        {
            ...
            net.freerouting.library.LogicalPart.PartPin curr_part_pin =  logical_part.get_pin(i);
    ...
    public java.awt.Color[] get_draw_colors(net.freerouting.boardgraphics.GraphicsContext p_graphics_context)
    {
    ...
    public double get_draw_intensity(net.freerouting.boardgraphics.GraphicsContext p_graphics_context)
    {
    ...
    public double get_min_width(int p_layer)
    {
        ...
        net.freerouting.geometry.planar.IntBox padstack_bounding_box = padstack_shape.bounding_box();
    ...
    public void print_info(ObjectInfoPanel p_window, java.util.Locale p_locale)
    {
        ...
        net.freerouting.library.Padstack padstack = this.get_padstack();
