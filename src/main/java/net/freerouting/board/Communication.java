...
import net.freerouting.designformats.specctra.CoordinateTransform;
...
public class Communication implements java.io.Serializable {
    ...
    public Communication() {
        this(Unit.MIL, 1, new SpecctraParserInfo("\"", null, null, null, null, false),
                new CoordinateTransform(1, 0, 0), new net.freerouting.board.ItemIdNoGenerator(), new BoardObserverAdaptor());
    }
