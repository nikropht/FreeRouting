...
public class Package {
    ...
    public static void write_scope(WriteScopeParameter p_par, net.freerouting.library.Package p_package) throws java.io.IOException {
        ...
        for (int i = 0; i < p_package.pin_count(); ++i) {
            net.freerouting.library.Package.Pin curr_pin = p_package.get_pin(i);
            p_par.file.new_line();
            p_par.file.write("(pin ");
            net.freerouting.library.Padstack curr_padstack = p_par.board.library.padstacks.get(curr_pin.padstack_no);
    ...
    private static void write_package_keepout(net.freerouting.library.Package.Keepout p_keepout, WriteScopeParameter p_par,
                                              boolean p_is_via_keepout) throws java.io.IOException {
        Layer keepout_layer;
        if (p_keepout.layer >= 0) {
            net.freerouting.board.Layer board_layer = p_par.board.layer_structure.arr[p_keepout.layer];
        ...
        if (p_keepout.area instanceof net.freerouting.geometry.planar.Shape) {
            boundary_shape = (net.freerouting.geometry.planar.Shape) p_keepout.area;
     ...
     */
    public static void write_placement_scope(WriteScopeParameter p_par, net.freerouting.library.Package p_package)
