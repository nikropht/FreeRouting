...
import net.freerouting.geometry.planar.Ellipse;
...
import net.freerouting.rules.Net;
...
public class Route
{
    ...
    private boolean snap_to_smd_center(int p_layer)
    {
        ...
        net.freerouting.board.Pin found_smd_pin = null;
        for (Item curr_item : picked_items)
        {
            if (curr_item instanceof net.freerouting.board.Pin && curr_item.shares_net_no(this.net_no_arr))
            {
    ...
    private Set<SwapPinInfo> calculate_swap_pin_infos()
    {
        ...
        for (Item curr_item : this.target_set)
        {
            ...
            {
                Collection<net.freerouting.board.Pin> curr_swapppable_pins = ((net.freerouting.board.Pin) curr_item).get_swappable_pins();
                for (net.freerouting.board.Pin curr_swappable_pin : curr_swapppable_pins)
                {
    ...
    {
        if (!(this.start_item instanceof net.freerouting.board.Pin))
        {
            return this.prev_corner;
        }
        net.freerouting.board.Pin start_pin = (net.freerouting.board.Pin) this.start_item;
    ...
    {
        if (!(this.nearest_target_item instanceof net.freerouting.board.Pin))
        {
            return p_from_corner;
        }
        net.freerouting.board.Pin target_pin = (net.freerouting.board.Pin) this.nearest_target_item;
    ...
    private class SwapPinInfo implements Comparable<SwapPinInfo>
    {
        ...
        SwapPinInfo(net.freerouting.board.Pin p_pin)
        {
            pin = p_pin;
            incomplete = null;
            ...
            if (nearest_point != null)
            {
                incomplete = new net.freerouting.geometry.planar.FloatLine(pin_center, nearest_point);
            }
        }
        ...
        final net.freerouting.board.Pin pin;
        net.freerouting.geometry.planar.FloatLine incomplete;
    }
}