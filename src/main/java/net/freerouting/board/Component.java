...
public class Component implements UndoableObjects.Storable, ObjectInfoPanel.Printable, java.io.Serializable
{
     ...
     */
    public net.freerouting.library.LogicalPart get_logical_part()
    {
     ...
     */
    public void set_logical_part(net.freerouting.library.LogicalPart p_logical_part)
    {
    ...
    private net.freerouting.library.LogicalPart logical_part = null;
