...
import net.freerouting.board.ForcedViaAlgo;
...
public class MazeSearchAlgo
{
    ...
    private double check_neck_down_at_dest_pin(CompleteExpansionRoom p_room)
    {
        ...
        {
            if (curr_target_door.item instanceof net.freerouting.board.Pin)
            {
                return ((net.freerouting.board.Pin) curr_target_door.item).get_trace_neckdown_halfwidth(p_room.get_layer());
            }
        }
        return 0;
    }
