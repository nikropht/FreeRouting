...
import net.freerouting.rules.ClearanceMatrix;
...
public class WindowClearanceMatrix extends BoardSavableSubWindow {
    ...
    public WindowClearanceMatrix(BoardFrame p_board_frame) {
        ...
        this.resources = java.util.ResourceBundle.getBundle("net.freerouting.gui.WindowClearanceMatrix", p_board_frame.get_locale());
        ...
        net.freerouting.interactive.BoardHandling board_handling = board_frame.board_panel.board_handling;
     ...
     */
    public void refresh() {
        net.freerouting.board.BasicBoard routing_board = this.board_frame.board_panel.board_handling.get_routing_board();
    ...
    private void add_class() {
        ...
        final net.freerouting.board.BasicBoard routing_board = this.board_frame.board_panel.board_handling.get_routing_board();
        final net.freerouting.rules.ClearanceMatrix clearance_matrix = routing_board.rules.clearance_matrix;
        ...
        if (routing_board.get_test_level() == net.freerouting.board.TestLevel.RELEASE_VERSION) {
    ...
    private int max_name_length() {
        int result = 1;
        net.freerouting.rules.ClearanceMatrix clearance_matrix = board_frame.board_panel.board_handling.get_routing_board().rules.clearance_matrix;
        for (int i = 0; i < clearance_matrix.get_class_count(); ++i) {
    ...
    private class ClearanceTableModel extends javax.swing.table.AbstractTableModel implements java.io.Serializable {
        ...
        public ClearanceTableModel(net.freerouting.interactive.BoardHandling p_board_handling) {
            net.freerouting.rules.ClearanceMatrix clearance_matrix = p_board_handling.get_routing_board().rules.clearance_matrix;
        ...
        public void setValueAt(Object p_value, int p_row, int p_col) {
            ...
            net.freerouting.interactive.BoardHandling board_handling = board_frame.board_panel.board_handling;
            net.freerouting.datastructures.UndoableObjects item_list = board_handling.get_routing_board().item_list;
            ...
            for (; ; ) {
                net.freerouting.board.Item curr_item = (net.freerouting.board.Item) item_list.read_object(it);
                if (curr_item == null) {
                    break;
                }
