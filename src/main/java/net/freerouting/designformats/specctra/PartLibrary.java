...
public class PartLibrary  extends ScopeKeyword
{
    ...
    public static void write_scope(WriteScopeParameter p_par) throws java.io.IOException
    {
        ...
        {
            net.freerouting.library.LogicalPart curr_part =  logical_parts.get(i);
            p_par.file.start_scope();
            ...
            {
                net.freerouting.board.Component curr_compomnent = p_par.board.components.get(j);
        ...
        for (int i = 1; i <=  logical_parts.count(); ++i)
        {
            ...
            {
                p_par.file.new_line();
                net.freerouting.library.LogicalPart.PartPin curr_pin =  curr_part.get_pin(j);
