...
public class AutorouteSettings {
    ...
    static net.freerouting.interactive.AutorouteSettings read_scope(Scanner p_scanner, LayerStructure p_layer_structure) {
        net.freerouting.interactive.AutorouteSettings result = new net.freerouting.interactive.AutorouteSettings(p_layer_structure.arr.length);
    ...
    static net.freerouting.interactive.AutorouteSettings read_layer_rule(Scanner p_scanner, LayerStructure p_layer_structure,
                                                                         net.freerouting.interactive.AutorouteSettings p_settings) {
    ...
    static void write_scope(IndentFileWriter p_file, net.freerouting.interactive.AutorouteSettings p_settings,
                            net.freerouting.board.LayerStructure p_layer_structure, IdentifierType p_identifier_type) throws java.io.IOException {
        p_file.start_scope();
        ...
        for (int i = 0; i < p_layer_structure.arr.length; ++i) {
            net.freerouting.board.Layer curr_layer = p_layer_structure.arr[i];
            p_file.start_scope();
