...
public class ComponentOutline extends Item implements java.io.Serializable
{
    ...
    protected net.freerouting.geometry.planar.TileShape[] calculate_tree_shapes(ShapeSearchTree p_search_tree)
    {
        return new net.freerouting.geometry.planar.TileShape[0];
    }
    ...
    {
        return net.freerouting.boardgraphics.Drawable.MIDDLE_DRAW_PRIORITY;
    }
    ...
    public net.freerouting.geometry.planar.IntBox bounding_box()
    {
