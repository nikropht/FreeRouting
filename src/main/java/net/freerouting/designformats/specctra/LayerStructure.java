...
public class LayerStructure {
     ...
     */
    public LayerStructure(net.freerouting.board.LayerStructure p_board_layer_structure) {
        arr = new Layer[p_board_layer_structure.arr.length];
        for (int i = 0; i < arr.length; ++i) {
            net.freerouting.board.Layer board_layer = p_board_layer_structure.arr[i];
