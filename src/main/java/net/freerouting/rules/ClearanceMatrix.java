...
public class ClearanceMatrix implements java.io.Serializable {
     ...
     */
    public ClearanceMatrix(int p_class_count, net.freerouting.board.LayerStructure p_layer_structure, String[] p_name_arr) {
     ...
     */
    public static ClearanceMatrix get_default_instance(net.freerouting.board.LayerStructure p_layer_structure, int p_default_value) {
     ...
     */
    private class Row implements net.freerouting.board.ObjectInfoPanel.Printable, java.io.Serializable {
        final String name;
