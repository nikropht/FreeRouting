 ...
 * @author Alfons Wirtz
 */
public class NetClass implements java.io.Serializable, net.freerouting.board.ObjectInfoPanel.Printable
{

    /** Creates a new instance of NetClass */
    public NetClass(String p_name, net.freerouting.board.LayerStructure p_layer_structure, ClearanceMatrix p_clearance_matrix)
    {
        this.name = p_name;
    ...
    private final net.freerouting.board.LayerStructure board_layer_structure;
    /**
