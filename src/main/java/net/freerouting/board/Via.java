...
public class Via extends DrillItem implements java.io.Serializable
{
    ...
    public net.freerouting.autoroute.ExpansionDrill get_autoroute_drill_info(ShapeSearchTree p_autoroute_tree)
    {
        if (this.autoroute_drill_info == null)
        {
            net.freerouting.autoroute.ItemAutorouteInfo via_autoroute_info = this.get_autoroute_info();
            TileShape curr_drill_shape = TileShape.get_instance(this.get_center());
            this.autoroute_drill_info =
                    new net.freerouting.autoroute.ExpansionDrill(curr_drill_shape, this.get_center(), this.first_layer(), this.last_layer());
    ...
    transient private net.freerouting.autoroute.ExpansionDrill autoroute_drill_info = null;
}
