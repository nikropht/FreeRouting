...
public class RatsNest
{
     ...
     */
    public static class AirLine implements Comparable<AirLine>, net.freerouting.board.ObjectInfoPanel.Printable
    {
        ...
        private String item_info(Item p_item)
        {
            java.util.ResourceBundle resources =
                    java.util.ResourceBundle.getBundle("net.freerouting.interactive.RatsNest", this.locale);
            String result;
            if (p_item instanceof net.freerouting.board.Pin)
            {
                net.freerouting.board.Pin curr_pin = (net.freerouting.board.Pin) p_item;
        ...
        {
            java.util.ResourceBundle resources =
                    java.util.ResourceBundle.getBundle("net.freerouting.interactive.RatsNest", p_locale);
