...
public class BoardMenuFile extends javax.swing.JMenu
{
    ...
    public void add_design_dependent_items()
    {
        ...
        if ((routing_board.get_test_level() != net.freerouting.board.TestLevel.RELEASE_VERSION || !host_cad_is_eagle))
        {
    ...
    private void save_defaults_action()
    {
        ...
        {
            write_ok = net.freerouting.gui.GUIDefaultsFile.write(board_frame, board_frame.board_panel.board_handling, output_stream);
        }
        if (write_ok)
        {
    ...
    private BoardMenuFile(BoardFrame p_board_frame, boolean p_session_file_option)
    {
        ...
        resources = java.util.ResourceBundle.getBundle("net.freerouting.gui.BoardMenuFile", p_board_frame.get_locale());
    }
