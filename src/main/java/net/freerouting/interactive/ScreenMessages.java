...
public class ScreenMessages
{
    ...
    {
        resources = java.util.ResourceBundle.getBundle("net.freerouting.interactive.ScreenMessages", p_locale);
        locale = p_locale;
    ...
    public void set_mouse_position(net.freerouting.geometry.planar.FloatPoint p_pos)
    {
