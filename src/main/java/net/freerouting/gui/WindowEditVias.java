...
import net.freerouting.rules.ViaInfos;
...
public class WindowEditVias extends BoardSavableSubWindow {
    ...
    public WindowEditVias(BoardFrame p_board_frame) {
        this.resources = java.util.ResourceBundle.getBundle("net.freerouting.gui.WindowEditVias", p_board_frame.get_locale());
    ...
    private class AddViaListener implements java.awt.event.ActionListener {
        public void actionPerformed(java.awt.event.ActionEvent p_evt) {
            ...
            net.freerouting.rules.NetClass default_net_class = routing_board.rules.get_default_net_class();
            ViaInfo new_via = new ViaInfo(new_name, routing_board.library.get_via_padstack(0),
                    default_net_class.default_item_clearance_classes.get(net.freerouting.rules.DefaultItemClearanceClasses.ItemClass.VIA),
    ...
    private class RemoveViaListener implements java.awt.event.ActionListener {
        public void actionPerformed(java.awt.event.ActionEvent p_evt) {
            ...
            for (net.freerouting.rules.ViaRule curr_rule : board_rules.via_rules) {
    ...
    private class ViaTableModel extends javax.swing.table.AbstractTableModel {
        ...
        public void setValueAt(Object p_value, int p_row, int p_col) {
            ...
            if (p_col == ColumnName.NAME.ordinal()) {
                ...
                String new_name = (String) p_value;
                net.freerouting.library.Padstack new_padstack = routing_board.library.get_via_padstack(new_name);
