...
public class SessionToEagle extends javax.swing.JFrame
{
    ...
    public static boolean get_instance(java.io.InputStream p_session, java.io.OutputStream p_output_stream,
            net.freerouting.board.BasicBoard p_board)
    {
    ...
    SessionToEagle(Scanner p_scanner, java.io.OutputStreamWriter p_out_file, net.freerouting.board.BasicBoard p_board,
            net.freerouting.board.Unit p_unit, double p_session_file_scale_dominator, double p_board_scale_factor)
    {
        scanner = p_scanner;
        out_file = p_out_file;
        board = p_board;
    ...
    private boolean process_via_scope(String p_net_name) throws java.io.IOException
    {
        ...
        net.freerouting.library.Padstack via_padstack = this.board.library.padstacks.get(padstack_name);
        ...
        net.freerouting.geometry.planar.ConvexShape via_shape = via_padstack.get_shape(via_padstack.from_layer());
        ...
        else if (via_shape instanceof net.freerouting.geometry.planar.IntOctagon)
        {
    ...
    {
        java.util.Collection<net.freerouting.board.Pin> component_pins = this.board.get_component_pins(p_component_no);
        boolean component_has_swapped_pins = false;
        for (net.freerouting.board.Pin curr_pin : component_pins)
        {
    ...
    private void write_pin_swap( net.freerouting.board.Pin p_pin_1, net.freerouting.board.Pin p_pin_2) throws java.io.IOException
    {
    ...
    private final net.freerouting.board.BasicBoard board;
    
    /** The layer structure in specctra format */
    private final LayerStructure specctra_layer_structure;
    
    private final net.freerouting.board.Unit unit;
    ...
    {
        PinInfo(net.freerouting.board.Pin p_pin)
        {
            pin = p_pin;
            curr_changed_to = p_pin;
        }
        final net.freerouting.board.Pin pin;
        net.freerouting.board.Pin curr_changed_to;
    }
}
