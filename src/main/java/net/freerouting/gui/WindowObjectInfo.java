 ...
 * @author Alfons Wirtz
 */
public class WindowObjectInfo extends BoardTemporarySubWindow implements net.freerouting.board.ObjectInfoPanel
{
    /**
     ...
     */
    public static void display(Collection<net.freerouting.board.Item> p_item_list,
            BoardFrame p_board_frame, net.freerouting.board.CoordinateTransform p_coordinate_transform, java.awt.Point p_location)
    {
        ...
        for (WindowObjectInfo.Printable curr_object : p_item_list)
        {
            ...
            if (curr_object instanceof net.freerouting.board.Pin)
            {
                ++pin_count;
            }
            else if (curr_object instanceof net.freerouting.board.Via)
            {
                ++via_count;
            }
            else if (curr_object instanceof net.freerouting.board.Trace)
            {
                ++trace_count;
                cumulative_trace_length += ((net.freerouting.board.Trace) curr_object).get_length();
            }
        }
    ...
    public static WindowObjectInfo display(String p_title, Collection<Printable> p_object_list,
            BoardFrame p_board_frame, net.freerouting.board.CoordinateTransform p_coordinate_transform)
    {
    ...
    private WindowObjectInfo(BoardFrame p_board_frame, net.freerouting.board.CoordinateTransform p_coordinate_transform)
    {
        super(p_board_frame);
        this.resources = 
                java.util.ResourceBundle.getBundle("net.freerouting.gui.WindowObjectInfo", p_board_frame.get_locale());
     ...
     * Returns false, if that was not possible.
     */
    public boolean append(net.freerouting.geometry.planar.FloatPoint p_point)
    {
        net.freerouting.geometry.planar.FloatPoint transformed_point = this.coordinate_transform.board_to_user(p_point);
     ...
     * Returns false, if that was not possible.
     */
    public boolean append(net.freerouting.geometry.planar.Shape p_shape, java.util.Locale p_locale)
    {
        net.freerouting.board.PrintableShape transformed_shape = this.coordinate_transform.board_to_user(p_shape, p_locale);
     ...
     */
    public boolean append_items( String p_button_name, String p_window_title, java.util.Collection<net.freerouting.board.Item> p_items)
    {
        java.util.Collection<WindowObjectInfo.Printable> object_list = new java.util.LinkedList<WindowObjectInfo.Printable>();
    ...
    private final net.freerouting.board.CoordinateTransform coordinate_transform;
