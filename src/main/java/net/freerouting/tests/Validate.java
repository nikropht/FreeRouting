...
public class Validate
{
    ...
    {
        if (p_board.get_test_level() == net.freerouting.board.TestLevel.RELEASE_VERSION)
        {
            return true;
        }
        boolean result = true;
    ...
    static public boolean has_cycles(String p_s, BasicBoard p_board)
    {
        ...
        while (it.hasNext())
        {
            ...
            if(((net.freerouting.board.Trace)curr_item).is_cycle())
            {
                System.out.print(p_s);
    ...
    static public boolean trace_count_exceeded(String p_s, BasicBoard p_board, int p_net_no, int p_max_count)
    {
        ...
        {
            Item curr_ob = it.next();
            if(curr_ob instanceof net.freerouting.board.Trace)
            {
                if (((net.freerouting.board.Trace)curr_ob).contains_net(p_net_no))
                {
                    ++found_traces;
                }
            }
