...
import net.freerouting.rules.NetClass;
...
public class WindowNetClasses extends BoardSavableSubWindow
{
    ...
    {
        this.resources = java.util.ResourceBundle.getBundle("net.freerouting.gui.WindowNetClasses", p_board_frame.get_locale());
        ...
        net.freerouting.board.BasicBoard routing_board = p_board_frame.board_panel.board_handling.get_routing_board();
    ...
    private class SelectClassesListener implements java.awt.event.ActionListener
    {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            net.freerouting.rules.Nets nets = routing_board.rules.nets;
            ...
            for (net.freerouting.board.Item curr_item : board_items)
            {
                ...
                {
                    net.freerouting.rules.NetClass curr_net_class = nets.get(curr_item.get_net_no(i)).get_class();
        ...
        void set_trace_width_field(int p_rule_no, ComboBoxLayer.Layer p_layer)
        {
            ...
            else if (p_layer.index == ComboBoxLayer.INNER_LAYER_INDEX)
            {
                ...
                else
                {
                    ...
                    net.freerouting.board.LayerStructure layer_structure = board_handling.get_routing_board().layer_structure;
